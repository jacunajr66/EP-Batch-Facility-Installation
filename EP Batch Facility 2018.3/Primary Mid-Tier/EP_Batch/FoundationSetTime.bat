...
REM # 
REM #  Created by John Acuna Version 1.0.0.0 on 2/19/2013
REM #  
...
FOR /f %%i IN ('LatestFactDataTime %FOUNDATIONUSER% %DATASOURCE% %DEFAULTFTFTABLE% %DEFAULTFTFTIMECOLUMN%') DO SET TIME_MEMBER=%%i

FoundationRestartStatus %FOUNDATIONUSER% %DATASOURCE% pkbfstrstime
