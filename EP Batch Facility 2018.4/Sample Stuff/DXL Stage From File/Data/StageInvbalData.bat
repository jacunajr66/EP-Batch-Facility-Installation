...
REM # ==============================================================================
REM #  Purpose:
REM #     Looks for Inventory data files and stages the contents to the EKB schema.
REM # ==============================================================================
...
SET EXPIREDAYS=28
SET FILEPREFIX=PKB_ACTUAL_INVBAL_*

SET ARCHIVEDIR=.\Archive
SET BADDIR=.\Bad\
SET DISCARDDIR=.\Discard\
SET LOGDIR=.\Log\
SET DATADIR=.\Archive\Invbal.%DATE:~-2,2%-%DATE:~-10,2%-%DATE:~-7,2%
...
REM # ==============================================================================
REM #  Search for Inventory data files from host, generate the SQL Loader
...
FOR %%a IN (%FILEPREFIX%) DO (
   ...
   ECHO ^(trans_id,product_name,organization_name,calendar_name,eop_cst,eop_rtl,eop_unt^)>>%CONTROLFILE%
