...
REM # ==============================================================================
REM #  Purpose:
REM #     Looks for On Order data files and stages the contents to the EKB schema.
REM # ==============================================================================
...
SET EXPIREDAYS=28
SET FILEPREFIX=PKB_ACTUAL_ON_ORDER_*

SET ARCHIVEDIR=.\Archive
SET BADDIR=.\Bad\
SET DISCARDDIR=.\Discard\
SET LOGDIR=.\Log\
SET DATADIR=.\Archive\On_Order.%DATE:~-2,2%-%DATE:~-10,2%-%DATE:~-7,2%
...
REM # ==============================================================================
REM #  Search for On_Order data files from host, generate the SQL Loader
...
FOR %%a IN (%FILEPREFIX%) DO (
   ...
   ECHO ^(trans_id,product_name,organization_name,calendar_name,oo_cst,oo_rtl,oo_unt^)>>%CONTROLFILE%
