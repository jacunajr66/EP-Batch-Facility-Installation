...
REM # ==============================================================================
REM #  Purpose:
REM #     Looks for Markdowns data files and stages the contents to the EKB schema.
REM # ==============================================================================
...
SET EXPIREDAYS=28
SET FILEPREFIX=PKB_ACTUAL_MKDNS_*

SET ARCHIVEDIR=.\Archive
SET BADDIR=.\Bad\
SET DISCARDDIR=.\Discard\
SET LOGDIR=.\Log\
SET DATADIR=.\Archive\Mkdns.%DATE:~-2,2%-%DATE:~-10,2%-%DATE:~-7,2%
...
REM # ==============================================================================
REM #  Search for Markdowns data files from host, generate the SQL Loader
...
FOR %%a IN (%FILEPREFIX%) DO (
   ...
   ECHO ^(trans_id,product_name,organization_name,calendar_name,mdpmd_rtl,mdpmdmu_rtl,mdposd_rtl,mdposm_rtl^)>>%CONTROLFILE%
