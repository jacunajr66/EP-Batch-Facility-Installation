...
REM # 
REM #  Created by John Acuna Version 2018.4.0.0 on 11/2/2016
REM #  
...
REM # ==============================================================================
REM #  Purpose:
REM #     Looks for Other Inventory data files and stages the contents to the EKB 
REM #     schema.
REM # ==============================================================================
...
SET EXPIREDAYS=28
SET FILEPREFIX=PKB_ACTUAL_OTHINV_*

SET ARCHIVEDIR=.\Archive
SET BADDIR=.\Bad\
SET DISCARDDIR=.\Discard\
SET LOGDIR=.\Log\
SET DATADIR=.\Archive\Othinv.%DATE:~-2,2%-%DATE:~-10,2%-%DATE:~-7,2%
...
REM # ==============================================================================
REM #  Search for Other Inventory data files from host, generate the SQL Loader
...
FOR %%a IN (%FILEPREFIX%) DO (
   ...
   ECHO ^(trans_id,product_name,organization_name,calendar_name,dmg_cst,dmg_rtl,dmg_unt,shr_cst,shr_rtl,shr_unt,snadj_rtl,snadj_unt^)>>%CONTROLFILE%
