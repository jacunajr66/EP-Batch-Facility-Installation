...
REM # ==============================================================================
REM #  Purpose:
REM #     Looks for Sales data files and stages the contents to the EKB schema.
REM # ==============================================================================
...
SET EXPIREDAYS=28
SET FILEPREFIX=PKB_ACTUAL_SALES_*

SET ARCHIVEDIR=.\Archive
SET BADDIR=.\Bad\
SET DISCARDDIR=.\Discard\
SET LOGDIR=.\Log\
SET DATADIR=.\Archive\Sales.%DATE:~-2,2%-%DATE:~-10,2%-%DATE:~-7,2%
...
REM # ==============================================================================
REM #  Search for Sales data files from host, generate the SQL Loader
...
FOR %%a IN (%FILEPREFIX%) DO (
   ...
   ECHO ^(trans_id,product_name,organization_name,calendar_name,slsd_cst,slsd_rtl,slsd_unt,slsm_cst,slsm_rtl,slsm_unt^)>>%CONTROLFILE%
