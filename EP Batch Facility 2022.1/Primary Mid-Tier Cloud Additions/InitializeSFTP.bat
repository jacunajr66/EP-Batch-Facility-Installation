...
%~dp0CreateSFTPControlFiles %FOUNDATIONUSER% %DATASOURCE% %SQLLDRCONTROLPATH% actuals

IF %ERRORLEVEL% EQU 9000 (
   %~dp0CreateSFTPControlFiles %JIUSER% %DATASOURCE% %SQLLDRCONTROLPATH% structure
