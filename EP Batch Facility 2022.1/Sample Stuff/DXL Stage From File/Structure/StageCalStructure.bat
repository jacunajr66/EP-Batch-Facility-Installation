...
SET EXPIREDAYS=28
SET FILEPREFIX=AG_4_*

SET ARCHIVEDIR=.\Archive
SET BADDIR=.\Bad\
SET DISCARDDIR=.\Discard\
SET LOGDIR=.\Log\
SET STRUCTUREDIR=.\Archive\CalStructure.%DATE:~-2,2%-%DATE:~-10,2%-%DATE:~-7,2%
...
FOR %%a IN (%FILEPREFIX%) DO (
   ...
   ECHO ^(inputsequence,actioncode,current_id,id,parent_member_id,member_tech_key,messageid,messagetext,culture_name,short_description,long_description,matching_key,planningid,cal_startdate DATE "dd-mm-yy"^)>>%CONTROLFILE%
